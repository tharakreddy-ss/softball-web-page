...
import { ScorecardsContent } from "@/components/tournaments/subpages/SubpagesContent";
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <TournamentSubPage tournament={tournament} title="Scorecards" subtitle="Full innings and match cards">
      <ScorecardsContent />
    </TournamentSubPage>
  );
}
